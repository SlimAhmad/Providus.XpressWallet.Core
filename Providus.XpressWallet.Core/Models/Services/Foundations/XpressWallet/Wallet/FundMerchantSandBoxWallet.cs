...
{
    public class FundMerchantSandBoxWallet
    {
        public FundMerchantSandBoxWalletRequest Request { get; set; }

        public FundMerchantSandBoxWalletResponse Response { get; set; }
    }
}
